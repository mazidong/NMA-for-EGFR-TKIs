...
main_output_dir <- "/your_path_to_project/NMA-for-EGFR-TKI/outcomes/Subgroup_forest_plot/" # Change to your main output directory
...
file <- paste0(file_path, "Forest plot subgroup.xlsx")
excel_sheets(file)
...
group_conditions <- list(
  ...
  treat_line = c("front-line","subsequent-line")
)
...
if (length(results_list) > 0) {
  ...
  write.csv(final_results, "meta_analysis_results-monotherapy.csv", row.names = FALSE)
...
if (length(results_list) > 0) {
  final_results <- do.call(rbind, results_list)
  write.csv(final_results, "meta_analysis_results-generation.csv", row.names = FALSE)
  print("Results saved to meta_analysis_results.csv")
} else {
  print("No results to save.")
}
...
# ------------------------------- meta-analysis ------------------------------ #
csm <- metabin(event.e,n.e,event.c,n.c,data=cardiac_serious_placebo,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = generation)
vsm <- metabin(event.e,n.e,event.c,n.c,data=vascular_serious_placebo,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = generation)
ctm <- metabin(event.e,n.e,event.c,n.c,data=cardiac_total_placebo,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = generation)
vtm <- metabin(event.e,n.e,event.c,n.c,data=vascular_total_placebo,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = generation)

csm1 <- metabin(event.e,n.e,event.c,n.c,data=cardiac_serious_other,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = generation)
vsm1 <- metabin(event.e,n.e,event.c,n.c,data=vascular_serious_other,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = generation)
ctm1 <- metabin(event.e,n.e,event.c,n.c,data=cardiac_total_other,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = generation)
vtm1 <- metabin(event.e,n.e,event.c,n.c,data=vascular_total_other,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = generation)

arsm <- metabin(event.e,n.e,event.c,n.c,data=arrhy_serious_placebo,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
hfsm <- metabin(event.e,n.e,event.c,n.c,data=hf_serious_placebo,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
vtsm <- metabin(event.e,n.e,event.c,n.c,data=vt_serious_placebo,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
hysm <- metabin(event.e,n.e,event.c,n.c,data=hyper_serious_placebo,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
artm <- metabin(event.e,n.e,event.c,n.c,data=arrhy_total_placebo,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
hftm <- metabin(event.e,n.e,event.c,n.c,data=hf_total_placebo,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
vttm <- metabin(event.e,n.e,event.c,n.c,data=vt_total_placebo,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
hytm <- metabin(event.e,n.e,event.c,n.c,data=hyper_total_placebo,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)

arsm1 <- metabin(event.e,n.e,event.c,n.c,data=arrhy_serious_other,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
hfsm1 <- metabin(event.e,n.e,event.c,n.c,data=hf_serious_other,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
vtsm1 <- metabin(event.e,n.e,event.c,n.c,data=vt_serious_other,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
hysm1 <- metabin(event.e,n.e,event.c,n.c,data=hyper_serious_other,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
artm1 <- metabin(event.e,n.e,event.c,n.c,data=arrhy_total_other,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
hftm1 <- metabin(event.e,n.e,event.c,n.c,data=hf_total_other,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
vttm1 <- metabin(event.e,n.e,event.c,n.c,data=vt_total_other,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
hytm1 <- metabin(event.e,n.e,event.c,n.c,data=hyper_total_other,sm="OR",studlab=paste(author, year, sep = ","),comb.random=TRUE,robust=TRUE, byvar = generation)
...
csm4 <- metabin(event.e,n.e,event.c,n.c,data=cardiac_serious_Chemo,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = front_line)
vsm4 <- metabin(event.e,n.e,event.c,n.c,data=vascular_serious_Chemo,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = front_line)
ctm4 <- metabin(event.e,n.e,event.c,n.c,data=cardiac_total_Chemo,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = front_line)
vtm4 <- metabin(event.e,n.e,event.c,n.c,data=vascular_total_Chemo,sm="OR",studlab=paste(author, year, sep = ","), comb.random=TRUE,robust=TRUE, byvar = front_line)


# forest plots of head-to-head comparisons in pairwise meta-analysis 
# -------------------------------- forest_plot ------------------------------- #

pdf("primary-meta-forest(Three-generation subgroups vs Placebo).pdf", width = 14, height = 9)
...
pdf("secondary-meta-forest(Three-generation subgroups vs Placebo).pdf", width = 14, height = 9)
...
pdf("primary-meta-forest(Three-generation subgroups vs Other EGFR-TKI).pdf", width = 14, height =  12)
...
pdf("secondary-meta-forest(Three-generation subgroups vs Other EGFR-TKI).pdf", width = 14, height = 12)
...
pdf("primary-meta-forest(Gen1-EGFR-TKI vs chemotherapy).pdf", width = 14)
