...
main_output_dir <- "/your_path_to_project/NMA-for-EGFR-TKI/outcomes/Heatmap/" # Change to your main output directory
...
file <- paste0(file_path, "Heatmap.xlsx", sep = "")
...
ht3 = ht + ht1
ht3
pdf("primary-serious-total-heatmap.pdf", width = 9)
plot(ht3)
dev.off()
...
ht3 = ht + ht1
ht3
pdf("secondary-serious-total-heatmap.pdf", width = 12)
plot(ht3)
dev.off()
